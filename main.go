...
var rootCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Printf("Serving on %s from directory '%s' using %s...\n", address, absDir, protocol)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&protocol, "protocol", "HTTP/1.0", "conform to this HTTP version (default: HTTP/1.0)")
}
